...
public class QRCodeUtils {
    ...
    public static void main(String[] args) throws Exception {
        String text = "丢你的Only泄";  //这里设置自定义网站url  内容
        String logoPath = "D:\\project2\\news-search\\src\\main\\resources\\Snipaste_2022-07-12_13-40-31.png"; //二维码中间的logo 图片位置
        String destPath = "D:\\project2\\news-search\\src\\main\\resources\\QRCode";//生成二维码的位置
